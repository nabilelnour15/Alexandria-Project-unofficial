...
export const newsData: NewsArticle[] = [
  {
    ...
    summary:
      "The 40th edition of the festival brings cinema stars from around the Mediterranean to our historic city.",
    content: `
  ...
  },
  {
    ...
    summary:
      "The city announces a major renovation project for the historic Raml Station tram line.",
    content: `
    ...
    image:
      "https://images.unsplash.com/photo-1719210722273-2a5c7e967e65?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Tram/Train image
    isHot: false,
  },
  {
    id: "3",
    ...
    summary:
      "Tech leaders converge in Alexandria to discuss the future of AI and digital heritage.",
    content: `
    ...
    image:
      "https://images.unsplash.com/photo-1669329330758-cb84ab85113d?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Library interior
    isHot: true,
  },
  {
    id: "4",
    ...
    summary:
      "After years of renovation, the museum reopens its doors to showcase thousands of artifacts.",
    content: `
    ...
    image:
      "https://www.ekathimerini.com/wp-content/uploads/2023/10/Greco-Roman-Museum-9.jpg", // Museum/Classical art
    isHot: false,
  },
  {
    id: "5",
    ...
    summary:
      "Hotels and resorts prepare for a busy winter season with special Mediterranean packages.",
    content: `
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/c/ca/Alexandria_in_Winter.jpg",
    isHot: false,
  },
];
