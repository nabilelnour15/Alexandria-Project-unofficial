...
const AchievementSection = ({ achievement }: { achievement: Achievement }) => (
  ...
  >
    <div>
      <h3 className="text-3xl font-black text-slate-900 mb-6 font-['Montserrat']">
        {achievement.title}
      </h3>
      ...
      <div className="space-y-4">
        {achievement.items.map((item, idx) => (
          <div
            key={idx}
            className="flex gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100 group hover:border-[#0068c8]/30 transition-all"
          >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      <div className="col-span-1 sm:col-span-2">
        <PlaceholderImage
          text={`${achievement.title} Visualization`}
          className="aspect-video [&_img]:object-top"
          src={achievement.image}
          alt={`${achievement.title} Visualization`}
        />
      </div>
      {achievement.stats?.map((stat, idx) => (
        ...
        >
          <p className="text-[#0068c8] text-3xl font-black mb-1 font-['Montserrat']">
            {stat.value}
          </p>
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-slate-600 mb-10 max-w-xl leading-relaxed">
                  Leading Alexandria's transformation into a world-class smart
                  city, balancing historical preservation with futuristic
              ...
              >
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white">
                  <PlaceholderImage
                    text="Official Portrait: Vice-Admiral Ahmed Khaled Hassan Saeed"
              ...
              {governorData.quickStats.map((stat, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-4xl font-black text-slate-900 mb-2 font-['Montserrat']">
                      {stat.value}
                    </h3>
                ...
                <div className="w-full md:w-1/3">
                  <div className="sticky top-32">
                    ...
                    <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 italic text-slate-500 text-sm">
                      "Building Alexandria's future requires the same
                      discipline, strategy, and dedication as defending Egyptian
                      waters."
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-2/3">
                  <div className="prose prose-lg prose-slate max-w-none">
                    ...
                    <div className="space-y-6">
                      {governorData.biography.militaryCareer.map(
                        (item, idx) => (
        ...
        <section className="py-32 bg-slate-50">
          <div className="alex-container">
            <div className="text-center mb-16">
              <span className="text-[#0068c8] font-black uppercase tracking-[0.2em] text-xs mb-4 block">
                Milestones 2024-2025
              </span>
              <h2 className="text-5xl font-black text-slate-900 font-['Montserrat'] mb-6">
            ...
            <div className="max-w-5xl mx-auto">
              <div className="flex flex-wrap justify-center gap-4 mb-20">
                {[
                  ...
                  >
                    <tab.icon
                      className={`w-5 h-5 ${activeTab === tab.id ? "text-white" : "text-[#0068c8]"}`}
                    />
                    {tab.label}
                  </button>
                ))}
              ...
              <div className="bg-white p-8 lg:p-16 rounded-[3rem] shadow-sm border border-slate-100">
                <AnimatePresence mode="wait">
                  {activeTab === "infrastructure" && (
                    <AchievementSection
                      key="infra"
                      achievement={governorData.achievements.infrastructure}
                    />
                  )}
                  {activeTab === "sustainability" && (
                    <AchievementSection
                      key="sust"
                      achievement={governorData.achievements.sustainability}
                    />
                  )}
                  {activeTab === "publicServices" && (
                    <AchievementSection
                      key="pub"
                      achievement={governorData.achievements.publicServices}
                    />
                  )}
                </AnimatePresence>
              </div>
        ...
        <section className="py-32 bg-white relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-1/3 h-full overflow-hidden opacity-5 pointer-events-none">
            <div className="text-[20rem] font-black text-slate-900 leading-none">
              2030
            </div>
          </div>
          ...
          <div className="alex-container">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div>
                <span className="text-[#3898ec] font-black uppercase tracking-[0.2em] text-xs mb-4 block">
                  The Road Ahead
                </span>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {governorData.vision.pillars.map((pillar, idx) => (
                  ...
                  >
                    <h4 className="text-lg font-bold text-slate-900 mb-4 font-['Montserrat']">
                      {pillar.title}
                    </h4>
